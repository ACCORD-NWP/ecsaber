...
void UnstructuredInterpolator::apply(const patch::Variables & vars, const atlas::FieldSet & fset,
...
void UnstructuredInterpolator::applyAD(const patch::Variables & vars, atlas::FieldSet & fset,
