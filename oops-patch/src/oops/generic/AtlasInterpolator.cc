...
void fieldSetToVector(const patch::Variables& variables, const std::vector<bool>& mask,
...
void AtlasInterpolator::applyAD(
    const patch::Variables& variables, atlas::FieldSet& sourceFieldSet,
...
atlas::FieldSet AtlasInterpolator::copySourceFields(
    const patch::Variables& variables, const atlas::FieldSet& sourceFieldSet) const {
...
atlas::FieldSet AtlasInterpolator::createTargetFields(
    const patch::Variables& variables, const atlas::FunctionSpace& targetFunctionSpace,
...
patch::Variables AtlasInterpolator::createInterpVariables(
    const patch::Variables& inputVariables) const {
