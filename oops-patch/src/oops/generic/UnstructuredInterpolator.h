...
class UnstructuredInterpolator : public LocalInterpolatorBase,
 ...
 public:
  ...
  void apply(const patch::Variables &, const atlas::FieldSet &, std::vector<double> &) const override;
  void applyAD(const patch::Variables &, atlas::FieldSet &, const std::vector<double> &) const override;
  ...
  // input state.
  void apply(const patch::Variables &, const atlas::FieldSet &, const std::vector<bool> &,
             std::vector<double> &) const override;
  void applyAD(const patch::Variables &, atlas::FieldSet &, const std::vector<bool> &,
               const std::vector<double> &) const override;

  // MODEL-specific interface to generic interpolator
  template <typename MODEL>
  void apply(const patch::Variables &, const State<MODEL> &, std::vector<double> &) const;
  template <typename MODEL>
  void apply(const patch::Variables &, const Increment<MODEL> &, std::vector<double> &) const;
  template <typename MODEL>
  void applyAD(const patch::Variables &, Increment<MODEL> &, const std::vector<double> &) const;
  template <typename MODEL>
  void apply(const patch::Variables &, const State<MODEL> &, const std::vector<bool> &,
             std::vector<double> &) const;
  template <typename MODEL>
  void apply(const patch::Variables &, const Increment<MODEL> &, const std::vector<bool> &,
             std::vector<double> &) const;
  template <typename MODEL>
  void applyAD(const patch::Variables &, Increment<MODEL> &, const std::vector<bool> &,
...
template<typename MODEL>
void UnstructuredInterpolator::apply(const patch::Variables & vars, const State<MODEL> & xx,
...
template<typename MODEL>
void UnstructuredInterpolator::apply(const patch::Variables & vars, const Increment<MODEL> & dx,
                                     std::vector<double> & locvals) const
{
  std::vector<bool> target_mask(nout_, true);
...
template<typename MODEL>
void UnstructuredInterpolator::applyAD(const patch::Variables & vars, Increment<MODEL> & dx,
