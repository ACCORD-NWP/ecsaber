...
class LocalInterpolatorBase : public util::Printable {
 public:
  ...
  /// mask).
  virtual void apply(const patch::Variables& variables, const atlas::FieldSet& sourceFieldSet,
  ...
  virtual void applyAD(const patch::Variables& variables, atlas::FieldSet& sourceFieldSet,
  ...
  static void bufferToFieldSet(const patch::Variables &, const std::vector<size_t> &,
                                const std::vector<double> &, atlas::FieldSet &);
  static void bufferToFieldSetAD(const patch::Variables &, const std::vector<size_t> &,
