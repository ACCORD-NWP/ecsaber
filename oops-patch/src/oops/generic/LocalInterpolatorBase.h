...
class LocalInterpolatorBase : public util::Printable {
 public:
  ...
  /// mask).
  virtual void apply(const JediVariables& variables, const atlas::FieldSet& sourceFieldSet,
  ...
  virtual void applyAD(const JediVariables& variables, atlas::FieldSet& sourceFieldSet,
  ...
  static void bufferToFieldSet(const JediVariables &, const std::vector<size_t> &,
                                const std::vector<double> &, atlas::FieldSet &);
  static void bufferToFieldSetAD(const JediVariables &, const std::vector<size_t> &,
