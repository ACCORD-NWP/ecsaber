...
const oops::JediVariables DustCoarseModeMassFraction_A::
...
oops::JediVariables DustCoarseModeMassFraction_A::ingredients() const
{
    return DustCoarseModeMassFraction_A::Ingredients;
}

oops::JediVariables DustCoarseModeMassFraction_A::trajectoryVars() const
{
