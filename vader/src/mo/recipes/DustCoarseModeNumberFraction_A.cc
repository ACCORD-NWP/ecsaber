...
const oops::JediVariables DustCoarseModeNumberFraction_A::
...
oops::JediVariables DustCoarseModeNumberFraction_A::ingredients() const
{
    return DustCoarseModeNumberFraction_A::Ingredients;
}

oops::JediVariables DustCoarseModeNumberFraction_A::trajectoryVars() const
{
