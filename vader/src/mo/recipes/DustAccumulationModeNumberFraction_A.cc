...
const oops::JediVariables DustAccumulationModeNumberFraction_A::
...
oops::JediVariables DustAccumulationModeNumberFraction_A::ingredients() const
{
    return DustAccumulationModeNumberFraction_A::Ingredients;
}

oops::JediVariables DustAccumulationModeNumberFraction_A::trajectoryVars() const
{
