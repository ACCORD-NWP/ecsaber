...
const oops::JediVariables DustAccumulationModeMassFraction_A::
...
oops::JediVariables DustAccumulationModeMassFraction_A::ingredients() const
{
    return DustAccumulationModeMassFraction_A::Ingredients;
}

oops::JediVariables DustAccumulationModeMassFraction_A::trajectoryVars() const
{
