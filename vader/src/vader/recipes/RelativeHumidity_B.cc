...
const oops::JediVariables RelativeHumidity_B::Ingredients{std::vector<std::string>{
...
oops::JediVariables RelativeHumidity_B::ingredients() const {
    return RelativeHumidity_B::Ingredients;
}

oops::JediVariables RelativeHumidity_B::trajectoryVars() const {
