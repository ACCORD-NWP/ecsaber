...
const oops::JediVariables HeightAboveMeanSeaLevelAtSurface_A::Ingredients{std::vector<std::string>{
...
oops::JediVariables HeightAboveMeanSeaLevelAtSurface_A::ingredients() const
{
