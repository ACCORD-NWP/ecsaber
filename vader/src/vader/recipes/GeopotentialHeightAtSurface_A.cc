...
const oops::JediVariables GeopotentialHeightAtSurface_A::Ingredients{std::vector<std::string>{
...
oops::JediVariables GeopotentialHeightAtSurface_A::ingredients() const
{
