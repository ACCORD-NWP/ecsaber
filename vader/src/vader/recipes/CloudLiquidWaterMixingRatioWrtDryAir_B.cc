...
const oops::JediVariables CloudLiquidWaterMixingRatioWrtDryAir_B::
...
oops::JediVariables CloudLiquidWaterMixingRatioWrtDryAir_B::ingredients() const
{
    return CloudLiquidWaterMixingRatioWrtDryAir_B::Ingredients;
}

oops::JediVariables CloudLiquidWaterMixingRatioWrtDryAir_B::trajectoryVars() const
{
