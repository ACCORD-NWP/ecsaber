...
const oops::JediVariables CloudLiquidWaterMixingRatioWrtWetAir_A::
...
oops::JediVariables CloudLiquidWaterMixingRatioWrtWetAir_A::ingredients() const
{
    return CloudLiquidWaterMixingRatioWrtWetAir_A::Ingredients;
}

oops::JediVariables CloudLiquidWaterMixingRatioWrtWetAir_A::trajectoryVars() const
{
    return oops::JediVariables{std::vector<std::string>{"cloud_liquid_water_mixing_ratio_wrt_dry_air",
                                                    "total_water_mixing_ratio_wrt_dry_air"}};
}
