...
const oops::JediVariables SaturationSpecificHumidity_B::Ingredients{
...
oops::JediVariables SaturationSpecificHumidity_B::ingredients() const {
  return Ingredients;
}

oops::JediVariables SaturationSpecificHumidity_B::trajectoryVars() const {
