...
const oops::JediVariables SaturationVaporPressure_B::Ingredients{
...
oops::JediVariables SaturationVaporPressure_B::ingredients() const {
  return Ingredients;
}

oops::JediVariables SaturationVaporPressure_B::trajectoryVars() const {
  return oops::JediVariables{std::vector<std::string>{"air_temperature", "svp"}};
}
