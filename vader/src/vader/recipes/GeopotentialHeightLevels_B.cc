...
const oops::JediVariables GeopotentialHeightLevels_B::Ingredients{
...
oops::JediVariables GeopotentialHeightLevels_B::ingredients() const
{
    return GeopotentialHeightLevels_B::Ingredients;
}

oops::JediVariables GeopotentialHeightLevels_B::trajectoryVars() const
{
  return oops::JediVariables{std::vector<std::string>{"ln_air_pressure_at_interface"}};
}
