...
const oops::JediVariables CloudIceMixingRatioWrtDryAir_B::
...
oops::JediVariables CloudIceMixingRatioWrtDryAir_B::ingredients() const
{
    return CloudIceMixingRatioWrtDryAir_B::Ingredients;
}

oops::JediVariables CloudIceMixingRatioWrtDryAir_B::trajectoryVars() const
{
