...
const oops::JediVariables GeopotentialLevels_A::Ingredients{
...
oops::JediVariables GeopotentialLevels_A::ingredients() const
{
    return GeopotentialLevels_A::Ingredients;
}

oops::JediVariables GeopotentialLevels_A::trajectoryVars() const
{
