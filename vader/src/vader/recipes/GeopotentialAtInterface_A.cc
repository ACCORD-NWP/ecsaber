...
const oops::JediVariables GeopotentialAtInterface_A::Ingredients{
...
oops::JediVariables GeopotentialAtInterface_A::ingredients() const
{
    return GeopotentialAtInterface_A::Ingredients;
}

oops::JediVariables GeopotentialAtInterface_A::trajectoryVars() const
{
    return oops::JediVariables{std::vector<std::string>{"ln_air_pressure",
                                                    "ln_air_pressure_at_interface"}};
}
