...
const oops::JediVariables WaterVaporMixingRatioWrtDryAir_A::
...
oops::JediVariables WaterVaporMixingRatioWrtDryAir_A::ingredients() const
{
    return WaterVaporMixingRatioWrtDryAir_A::Ingredients;
}

oops::JediVariables WaterVaporMixingRatioWrtDryAir_A::trajectoryVars() const
{
