...
const oops::JediVariables LnAirPressure_A::Ingredients{
...
oops::JediVariables LnAirPressure_A::ingredients() const {
    return LnAirPressure_A::Ingredients;
}

// -------------------------------------------------------------------------------------------------

oops::JediVariables LnAirPressure_A::trajectoryVars() const {
    return oops::JediVariables{std::vector<std::string>{"air_pressure"}};
}
