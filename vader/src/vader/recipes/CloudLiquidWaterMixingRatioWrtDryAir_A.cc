...
const oops::JediVariables CloudLiquidWaterMixingRatioWrtDryAir_A::
...
oops::JediVariables CloudLiquidWaterMixingRatioWrtDryAir_A::ingredients() const
{
    return CloudLiquidWaterMixingRatioWrtDryAir_A::Ingredients;
}

oops::JediVariables CloudLiquidWaterMixingRatioWrtDryAir_A::trajectoryVars() const
{
