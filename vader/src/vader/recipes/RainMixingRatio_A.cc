...
const oops::JediVariables RainMixingRatio_A::
...
oops::JediVariables RainMixingRatio_A::ingredients() const
{
    return RainMixingRatio_A::Ingredients;
}

oops::JediVariables RainMixingRatio_A::trajectoryVars() const
{
    return oops::JediVariables{std::vector<std::string>{"rain_mixing_ratio_wrt_dry_air",
                                                    "total_water_mixing_ratio_wrt_dry_air"}};
}
