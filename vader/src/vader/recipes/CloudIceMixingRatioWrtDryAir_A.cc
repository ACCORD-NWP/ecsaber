...
const oops::JediVariables CloudIceMixingRatioWrtDryAir_A::
...
oops::JediVariables CloudIceMixingRatioWrtDryAir_A::ingredients() const
{
    return CloudIceMixingRatioWrtDryAir_A::Ingredients;
}

oops::JediVariables CloudIceMixingRatioWrtDryAir_A::trajectoryVars() const
{
