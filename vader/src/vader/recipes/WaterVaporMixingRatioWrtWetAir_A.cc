...
const oops::JediVariables WaterVaporMixingRatioWrtWetAir_A::
...
oops::JediVariables WaterVaporMixingRatioWrtWetAir_A::ingredients() const
{
    return WaterVaporMixingRatioWrtWetAir_A::Ingredients;
}

oops::JediVariables WaterVaporMixingRatioWrtWetAir_A::trajectoryVars() const
{
    return oops::JediVariables{std::vector<std::string>{"water_vapor_mixing_ratio_wrt_dry_air",
                                                    "total_water_mixing_ratio_wrt_dry_air"}};
}
