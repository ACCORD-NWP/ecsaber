...
const oops::JediVariables WaterVaporMixingRatioWrtDryAir_B::
...
oops::JediVariables WaterVaporMixingRatioWrtDryAir_B::ingredients() const
{
    return WaterVaporMixingRatioWrtDryAir_B::Ingredients;
}

oops::JediVariables WaterVaporMixingRatioWrtDryAir_B::trajectoryVars() const
{
