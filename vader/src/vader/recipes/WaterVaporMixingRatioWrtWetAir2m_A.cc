...
const oops::JediVariables WaterVaporMixingRatioWrtWetAir2m_A::
...
oops::JediVariables WaterVaporMixingRatioWrtWetAir2m_A::ingredients() const
{
    return WaterVaporMixingRatioWrtWetAir2m_A::Ingredients;
}

oops::JediVariables WaterVaporMixingRatioWrtWetAir2m_A::trajectoryVars() const
{
