...
const oops::JediVariables GeopotentialHeightAtInterface_A::Ingredients{std::vector<std::string>{
                                                        "geopotential_levels"}};
...
oops::JediVariables GeopotentialHeightAtInterface_A::ingredients() const
{
