...
const oops::JediVariables CloudIceMixingRatioWrtWetAir_A::
...
oops::JediVariables CloudIceMixingRatioWrtWetAir_A::ingredients() const
{
    return CloudIceMixingRatioWrtWetAir_A::Ingredients;
}

oops::JediVariables CloudIceMixingRatioWrtWetAir_A::trajectoryVars() const
{
    return oops::JediVariables{std::vector<std::string>{"cloud_ice_mixing_ratio_wrt_dry_air",
                                                    "total_water_mixing_ratio_wrt_dry_air"}};
}
