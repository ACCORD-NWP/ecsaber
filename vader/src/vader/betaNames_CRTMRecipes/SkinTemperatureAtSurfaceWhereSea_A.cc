...
const oops::JediVariables SkinTemperatureAtSurfaceWhereSea_A::Ingredients{
...
oops::JediVariables SkinTemperatureAtSurfaceWhereSea_A::ingredients() const {
  return SkinTemperatureAtSurfaceWhereSea_A::Ingredients;
}

oops::JediVariables SkinTemperatureAtSurfaceWhereSea_A::trajectoryVars() const {
