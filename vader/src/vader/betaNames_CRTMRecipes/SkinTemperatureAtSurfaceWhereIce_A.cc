...
const oops::JediVariables SkinTemperatureAtSurfaceWhereIce_A::Ingredients{
...
oops::JediVariables SkinTemperatureAtSurfaceWhereIce_A::ingredients() const {
  return SkinTemperatureAtSurfaceWhereIce_A::Ingredients;
}

oops::JediVariables SkinTemperatureAtSurfaceWhereIce_A::trajectoryVars() const {
