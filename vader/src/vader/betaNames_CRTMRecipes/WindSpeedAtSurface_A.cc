...
const oops::JediVariables WindSpeedAtSurface_A::Ingredients{std::vector<std::string>{
...
oops::JediVariables WindSpeedAtSurface_A::ingredients() const {
  return WindSpeedAtSurface_A::Ingredients;
}

oops::JediVariables WindSpeedAtSurface_A::trajectoryVars() const {
  return WindSpeedAtSurface_A::Ingredients;
}
