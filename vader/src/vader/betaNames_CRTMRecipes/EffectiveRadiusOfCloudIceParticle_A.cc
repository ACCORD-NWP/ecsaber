...
const oops::JediVariables EffectiveRadiusOfCloudIceParticle_A::Ingredients{
...
oops::JediVariables EffectiveRadiusOfCloudIceParticle_A::ingredients() const {
...
oops::JediVariables EffectiveRadiusOfCloudIceParticle_A::trajectoryVars() const {
