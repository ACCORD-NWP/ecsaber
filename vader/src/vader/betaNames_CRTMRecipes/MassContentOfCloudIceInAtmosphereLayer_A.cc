...
const oops::JediVariables MassContentOfCloudIceInAtmosphereLayer_A::Ingredients{
...
oops::JediVariables MassContentOfCloudIceInAtmosphereLayer_A::ingredients() const {
  return MassContentOfCloudIceInAtmosphereLayer_A::Ingredients;
}

oops::JediVariables MassContentOfCloudIceInAtmosphereLayer_A::trajectoryVars() const {
  return oops::JediVariables{std::vector<std::string>{"cloud_liquid_ice", "air_pressure_thickness"}};
}
