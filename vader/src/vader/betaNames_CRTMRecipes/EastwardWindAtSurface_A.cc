...
const oops::JediVariables uwind_at_surface_A::Ingredients{
...
oops::JediVariables uwind_at_surface_A::ingredients() const {
  return uwind_at_surface_A::Ingredients;
}

oops::JediVariables uwind_at_surface_A::trajectoryVars() const {
