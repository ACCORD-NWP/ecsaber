...
const oops::JediVariables SkinTemperatureAtSurfaceWhereLand_A::Ingredients{std::vector<std::string>{
                            "skin_temperature"}};
...
oops::JediVariables SkinTemperatureAtSurfaceWhereLand_A::ingredients() const {
