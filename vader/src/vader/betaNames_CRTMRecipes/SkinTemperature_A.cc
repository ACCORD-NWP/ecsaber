...
const oops::JediVariables SkinTemperature_A::Ingredients{
...
oops::JediVariables SkinTemperature_A::ingredients() const {
  return SkinTemperature_A::Ingredients;
}

oops::JediVariables SkinTemperature_A::trajectoryVars() const {
