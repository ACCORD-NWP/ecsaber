...
const char CloudLiquidWater_A::Name[] =
    "CloudLiquidWater_A";
const oops::JediVariables CloudLiquidWater_A::Ingredients{
...
oops::JediVariables CloudLiquidWater_A::ingredients() const {
  return CloudLiquidWater_A::Ingredients;
}

oops::JediVariables CloudLiquidWater_A::trajectoryVars() const {
