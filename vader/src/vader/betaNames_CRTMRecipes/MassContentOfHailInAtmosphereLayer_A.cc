...
const oops::JediVariables MassContentOfHailInAtmosphereLayer_A::Ingredients{
...
oops::JediVariables MassContentOfHailInAtmosphereLayer_A::ingredients() const {
  return MassContentOfHailInAtmosphereLayer_A::Ingredients;
}

oops::JediVariables MassContentOfHailInAtmosphereLayer_A::trajectoryVars() const {
  return oops::JediVariables{std::vector<std::string>{"hail", "air_pressure_thickness"}};
}
