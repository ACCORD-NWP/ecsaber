...
const oops::JediVariables MassContentOfSnowInAtmosphereLayer_A::Ingredients{
...
oops::JediVariables MassContentOfSnowInAtmosphereLayer_A::ingredients() const {
  return MassContentOfSnowInAtmosphereLayer_A::Ingredients;
}

oops::JediVariables MassContentOfSnowInAtmosphereLayer_A::trajectoryVars() const {
  return oops::JediVariables{std::vector<std::string>{"snow_water", "air_pressure_thickness"}};
}
