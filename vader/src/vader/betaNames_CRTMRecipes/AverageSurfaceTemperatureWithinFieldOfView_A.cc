...
const oops::JediVariables AverageSurfaceTemperatureWithinFieldOfView_A::Ingredients{
...
oops::JediVariables AverageSurfaceTemperatureWithinFieldOfView_A::ingredients() const {
