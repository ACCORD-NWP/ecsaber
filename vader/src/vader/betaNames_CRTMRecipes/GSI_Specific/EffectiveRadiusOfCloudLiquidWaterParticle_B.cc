...
const oops::JediVariables EffectiveRadiusOfCloudLiquidWaterParticle_B::Ingredients{
...
oops::JediVariables EffectiveRadiusOfCloudLiquidWaterParticle_B::ingredients() const {
