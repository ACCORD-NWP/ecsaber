...
const oops::JediVariables MassContentOfCloudLiquidWaterInAtmosphereLayer_B::Ingredients{
...
oops::JediVariables MassContentOfCloudLiquidWaterInAtmosphereLayer_B::ingredients() const {
