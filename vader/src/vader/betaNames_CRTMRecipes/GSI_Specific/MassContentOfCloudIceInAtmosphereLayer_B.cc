...
const oops::JediVariables MassContentOfCloudIceInAtmosphereLayer_B::Ingredients{
...
oops::JediVariables MassContentOfCloudIceInAtmosphereLayer_B::ingredients() const {
