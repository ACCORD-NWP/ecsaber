...
const oops::JediVariables LeafAreaIndex_A::Ingredients{std::vector<std::string>{
...
oops::JediVariables LeafAreaIndex_A::ingredients() const { return LeafAreaIndex_A::Ingredients; }
