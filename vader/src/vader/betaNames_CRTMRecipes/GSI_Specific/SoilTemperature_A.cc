...
const oops::JediVariables SoilTemperature_A::Ingredients{std::vector<std::string>{
...
oops::JediVariables SoilTemperature_A::ingredients() const { return SoilTemperature_A::Ingredients; }
