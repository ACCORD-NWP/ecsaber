...
const oops::JediVariables VolumeFractionOfCondensedWaterInSoil_A::Ingredients{std::vector<std::string>{
...
oops::JediVariables VolumeFractionOfCondensedWaterInSoil_A::ingredients() const {
