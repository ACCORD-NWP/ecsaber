...
const oops::JediVariables SurfaceSnowAreaFraction_A::Ingredients{
...
oops::JediVariables SurfaceSnowAreaFraction_A::ingredients() const {
...
oops::JediVariables SurfaceSnowAreaFraction_A::trajectoryVars() const {
  return oops::JediVariables(std::vector<std::string>{"surface_snow_thickness"});
}
