...
const oops::JediVariables IceAreaFraction_A::Ingredients{
...
oops::JediVariables IceAreaFraction_A::ingredients() const {
...
oops::JediVariables IceAreaFraction_A::trajectoryVars() const {
