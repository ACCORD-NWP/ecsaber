...
const oops::JediVariables LandAreaFraction_A::Ingredients{
...
oops::JediVariables LandAreaFraction_A::ingredients() const {
...
oops::JediVariables LandAreaFraction_A::trajectoryVars() const {
