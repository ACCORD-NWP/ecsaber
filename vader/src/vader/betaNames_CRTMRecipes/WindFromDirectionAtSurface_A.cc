...
const oops::JediVariables WindFromDirectionAtSurface_A::Ingredients{std::vector<std::string>{
...
oops::JediVariables WindFromDirectionAtSurface_A::ingredients() const {
  return WindFromDirectionAtSurface_A::Ingredients;
}

oops::JediVariables WindFromDirectionAtSurface_A::trajectoryVars() const {
  return WindFromDirectionAtSurface_A::Ingredients;
}
