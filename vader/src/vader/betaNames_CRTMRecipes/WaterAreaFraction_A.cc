...
const oops::JediVariables WaterAreaFraction_A::Ingredients{
...
oops::JediVariables WaterAreaFraction_A::ingredients() const {
...
oops::JediVariables WaterAreaFraction_A::trajectoryVars() const {
  return oops::JediVariables(std::vector<std::string>{"landmask", "seaice_fraction"});
}
