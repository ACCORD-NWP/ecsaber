...
const oops::JediVariables WindToDirectionAtSurface_A::Ingredients{std::vector<std::string>{
...
oops::JediVariables WindToDirectionAtSurface_A::ingredients() const {
  return WindToDirectionAtSurface_A::Ingredients;
}

oops::JediVariables WindToDirectionAtSurface_A::trajectoryVars() const {
  return WindToDirectionAtSurface_A::Ingredients;
}
