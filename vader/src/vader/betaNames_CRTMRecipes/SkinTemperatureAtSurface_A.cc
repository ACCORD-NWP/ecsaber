...
const oops::JediVariables SkinTemperatureAtSurface_A::Ingredients{
...
oops::JediVariables SkinTemperatureAtSurface_A::ingredients() const {
  return SkinTemperatureAtSurface_A::Ingredients;
}

oops::JediVariables SkinTemperatureAtSurface_A::trajectoryVars() const {
