...
const oops::JediVariables vwind_at_surface_A::Ingredients{
...
oops::JediVariables vwind_at_surface_A::ingredients() const {
  return vwind_at_surface_A::Ingredients;
}

oops::JediVariables vwind_at_surface_A::trajectoryVars() const {
