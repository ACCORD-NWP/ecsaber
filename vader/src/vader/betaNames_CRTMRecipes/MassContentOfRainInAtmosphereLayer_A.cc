...
const oops::JediVariables MassContentOfRainInAtmosphereLayer_A::Ingredients{
...
oops::JediVariables MassContentOfRainInAtmosphereLayer_A::ingredients() const {
  return MassContentOfRainInAtmosphereLayer_A::Ingredients;
}

oops::JediVariables MassContentOfRainInAtmosphereLayer_A::trajectoryVars() const {
  return oops::JediVariables{std::vector<std::string>{"rain_water", "air_pressure_thickness"}};
}
