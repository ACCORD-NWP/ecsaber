...
const oops::JediVariables MassContentOfGraupelInAtmosphereLayer_A::Ingredients{
...
oops::JediVariables MassContentOfGraupelInAtmosphereLayer_A::ingredients() const {
  return MassContentOfGraupelInAtmosphereLayer_A::Ingredients;
}

oops::JediVariables MassContentOfGraupelInAtmosphereLayer_A::trajectoryVars() const {
  return oops::JediVariables{std::vector<std::string>{"graupel", "air_pressure_thickness"}};
}
