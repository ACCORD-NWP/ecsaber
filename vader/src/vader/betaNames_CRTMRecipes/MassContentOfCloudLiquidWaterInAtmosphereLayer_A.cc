...
const oops::JediVariables MassContentOfCloudLiquidWaterInAtmosphereLayer_A::Ingredients{
...
oops::JediVariables MassContentOfCloudLiquidWaterInAtmosphereLayer_A::ingredients() const {
  return MassContentOfCloudLiquidWaterInAtmosphereLayer_A::Ingredients;
}

oops::JediVariables MassContentOfCloudLiquidWaterInAtmosphereLayer_A::trajectoryVars() const {
  return oops::JediVariables{std::vector<std::string>{"cloud_liquid_water", "air_pressure_thickness"}};
}
