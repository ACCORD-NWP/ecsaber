...
const oops::JediVariables EffectiveRadiusOfSnowParticle_A::Ingredients{
...
oops::JediVariables EffectiveRadiusOfSnowParticle_A::ingredients() const {
...
oops::JediVariables EffectiveRadiusOfSnowParticle_A::trajectoryVars() const {
