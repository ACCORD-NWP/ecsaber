...
const char CloudLiquidIce_A::Name[] =
    "CloudLiquidIce_A";
const oops::JediVariables CloudLiquidIce_A::Ingredients{
...
oops::JediVariables CloudLiquidIce_A::ingredients() const {
  return CloudLiquidIce_A::Ingredients;
}

oops::JediVariables CloudLiquidIce_A::trajectoryVars() const {
