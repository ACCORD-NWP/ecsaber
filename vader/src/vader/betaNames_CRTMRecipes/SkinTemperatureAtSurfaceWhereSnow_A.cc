...
const oops::JediVariables SkinTemperatureAtSurfaceWhereSnow_A::Ingredients{std::vector<std::string>{
...
oops::JediVariables SkinTemperatureAtSurfaceWhereSnow_A::ingredients() const {
  return SkinTemperatureAtSurfaceWhereSnow_A::Ingredients;
}

oops::JediVariables SkinTemperatureAtSurfaceWhereSnow_A::trajectoryVars() const {
  return oops::JediVariables{std::vector<std::string>{"skin_temperature_at_surface"}};
}
