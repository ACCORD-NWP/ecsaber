...
const oops::JediVariables EffectiveRadiusOfCloudLiquidWaterParticle_A::Ingredients{
...
oops::JediVariables EffectiveRadiusOfCloudLiquidWaterParticle_A::ingredients() const {
...
oops::JediVariables EffectiveRadiusOfCloudLiquidWaterParticle_A::trajectoryVars() const {
  return oops::JediVariables{std::vector<std::string>{"air_temperature"}};
}
