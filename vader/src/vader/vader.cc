...
* \param[in,out] neededVars JediVariables to try to produce
...
oops::JediVariables Vader::changeVar(atlas::FieldSet & afieldset,
    ...
    oops::JediVariables ingredientVars(afieldset.field_names());
    ...
    oops::JediVariables varsProduced;
...
void Vader::changeVarTraj(atlas::FieldSet const & trajFieldset,
                          oops::JediVariables const & neededVars) {
...
*/
oops::JediVariables Vader::initTLAD(oops::JediVariables & ingredientVars) const {
...
*/
oops::JediVariables Vader::initTLAD(oops::JediVariables & ingredientVars,
    ...
    oops::JediVariables trajectoryVars(trajectory_.field_names());
    oops::JediVariables neededVars(toVariables_);
    oops::JediVariables neededVarsProduced(toVariables_);
...
* by vader clients, since they normally do not do anything with the execution plans.
*/
oops::JediVariables Vader::changeVarTL(atlas::FieldSet & afieldset) const
{
...
*/
oops::JediVariables Vader::changeVarAD(atlas::FieldSet & afieldset) const {
  vaderPlanType trajPlan;
...
*
*/
void Vader::planVariables(oops::JediVariables & ingredientVars,
    oops::JediVariables & neededVars,
    vaderPlanType & plan) const {
    vaderPlanType emptyTrajPlan;
    oops::JediVariables emptyTrajVars;
...
void Vader::planVariables(oops::JediVariables & ingredientVars,
                          ...
                          vaderPlanType & plan,
                          const bool planTLAD,
                          oops::JediVariables & trajectoryVars,
                          vaderPlanType & trajRecipeExecutionPlan) const {
    ...
    const oops::JediVariables targetVariables(neededVars);
...
*
*/
bool Vader::planVariable(oops::JediVariables & ingredientVars,
                         oops::JediVariables & neededVars,
        ...
        for (const auto & recipe : recipeList->second) {
            ...
            if (haveIngredient && planTLAD) {
                oops::Log::debug() <<
                    ...
                    << std::endl;
                oops::JediVariables trajNeededVars = recipe->trajectoryVars();
                oops::Log::debug() <<
