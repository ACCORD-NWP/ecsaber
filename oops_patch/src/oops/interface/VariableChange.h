...
class VariableChange : public util::Printable,
 ...
 public:
  ...
  /// change state variables to those specified in the JediVariables parameter
  void changeVar(State_ &, const JediVariables &) const;
  ///  changeVarInverse is no longer needed but remains for legacy code
  void changeVarInverse(State_ &, const JediVariables &) const;
