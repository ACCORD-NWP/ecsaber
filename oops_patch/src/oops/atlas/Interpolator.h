...
class Interpolator {
 public:
  ...
  static void bufferToFieldSet(const JediVariables &,
                               const std::vector<size_t> &,
                               const std::vector<double> &,
                               atlas::FieldSet &);
  static void bufferToFieldSetAD(const JediVariables &,
                                 const std::vector<size_t> &,
                                 std::vector<double> &,
