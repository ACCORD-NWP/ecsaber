...
void Interpolator::apply(const JediVariables& vars,
...
void Interpolator::applyAD(const JediVariables& vars,
...
void Interpolator::bufferToFieldSet(const JediVariables & vars,
...
void Interpolator::bufferToFieldSetAD(const JediVariables & vars,
                                      const std::vector<size_t> & buffer_indices,
