...
class MaskedVectorView {
 public:
  MaskedVectorView(const JediVariables& variables,
 ...
 private:
  const JediVariables& variables_;
...
void fieldSetToVector(const JediVariables& variables, const std::vector<bool>& mask,
...
void AtlasInterpolator::applyAD(
    const JediVariables& variables, atlas::FieldSet& sourceFieldSet,
    const std::vector<bool>& mask,
...
atlas::FieldSet AtlasInterpolator::copySourceFields(
    const JediVariables& variables, const atlas::FieldSet& sourceFieldSet) const {
...
atlas::FieldSet AtlasInterpolator::createTargetFields(
    const JediVariables& variables, const atlas::FunctionSpace& targetFunctionSpace,
...
JediVariables AtlasInterpolator::createInterpVariables(
    const JediVariables& inputVariables) const {
