...
class IncrementSet : public DataSetBase< Increment<MODEL>, Geometry<MODEL> > {
 ...
 public:
  IncrementSet(const Geometry_ &, const JediVariables &, const std::vector<util::DateTime> &,
  ...
  IncrementSet(const Geometry_ &, const JediVariables &, const std::vector<util::DateTime> &,
               ...
               const eckit::mpi::Comm & commEns = oops::mpi::myself());
  IncrementSet(const Geometry_ &, const JediVariables &, const States_ &);
  IncrementSet(const Geometry_ &, const JediVariables &, States_ &, const bool clearStates = false);
...
template<typename MODEL>
IncrementSet<MODEL>::IncrementSet(const Geometry_ & resol, const JediVariables & vars,
