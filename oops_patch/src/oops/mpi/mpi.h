...
/// \brief Perform the MPI *broadcast* operation on an oops::JediVariables object.
void broadcast(const eckit::mpi::Comm & comm, JediVariables & vars, const size_t root);
