...
class SaberCentralBlockGroupParameters : public oops::Parameters {
 ...
 public:
  ...
  oops::RequiredParameter<oops::JediVariables> variables{"variables", this};
...
class SaberCentralBlock : public util::Printable {
 ...
 private:
  ...
  size_t ngroup_;
  // Group variables
  std::vector<oops::JediVariables> groupInputVars_;
  // Group names
  ...
  std::vector<oops::JediVariables> groupInnerVars_;
