...
class SaberParametricBlockChainGroup {
 public:
  SaberParametricBlockChainGroup(const oops::JediVariables & vars,
  ...
  const std::string & name() const
    {return name_;}
  const oops::JediVariables & variables() const
    {return vars_;}
  const std::string & refVarName() const
    {return refVarName_;}
  const oops::JediVariables & chainVars() const
    {return chainVars_;}
  oops::JediVariables & chainVars()
    {return chainVars_;}
